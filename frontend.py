...
cursor.execute('CREATE TABLE IF NOT EXISTS items(item_id INT(4) PRIMARY KEY NOT NULL,item_name VARCHAR(50),seller_id INT(4) NOT NULL,price INT(8) NOT NULL,date_added DATE,rating FLOAT(2,1))' )
...
def add_item():
    ...
    data = (item_id,name,sid,price,date_added,rating)
    statement = "INSERT INTO items VALUES(%s,%s,%s,%s,%s,%s)"
    cursor.execute(statement,data)
    database.commit()
